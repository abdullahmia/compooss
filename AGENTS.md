...
Commits must follow [Conventional Commits](https://www.conventionalcommits.org) — enforced by Commitlint + Husky. Never skip hooks. Branch off `development`, not `main`.
