    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <section id="why-compooss" className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="relative mx-auto max-w-6xl px-6">
          ...
          {/* Comparison table */}
          <AnimatedSection>
            <div className="overflow-hidden rounded-2xl border border-white/[0.07] shadow-2xl shadow-black/40">

              {/* Table meta-header */}
              <div className="flex items-center justify-between border-b border-white/[0.06] bg-zinc-950/80 px-6 py-4">
                <div>
                  <p className="text-sm font-semibold text-zinc-200">
                    Feature comparison
                  </p>
                  <p className="mt-0.5 text-xs text-zinc-500">
                    How Compooss stacks up against the alternatives
                  </p>
                </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[580px] text-left">
                  <thead>
                    <tr className="border-b border-white/[0.05] bg-zinc-950/50">
                      <th className="w-[36%] px-5 py-3.5 text-[11px] font-semibold uppercase tracking-wider text-zinc-600">
                        Feature
                      </th>
                      {COMPARISON_TOOLS.map((tool) => (
                        <th
                          key={tool.name}
                          className={`relative w-[16%] px-3 py-3.5 text-center text-xs font-bold ${
                            tool.highlight
                        ...
                        >
                          {tool.highlight && (
                            <>
                              <div className="absolute inset-x-0 top-0 h-0.5 bg-gradient-to-r from-transparent via-emerald-400/80 to-transparent" />
                              <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 rounded-full bg-emerald-500 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wide text-zinc-950">
                                You
                              </span>
                            </>
                          )}
                  ...
                  <tbody className="divide-y divide-white/[0.03] bg-zinc-900/20">
