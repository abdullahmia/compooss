...
import { StageCard } from "@/lib/components/collections/aggregations/stage-card.component";
import {
  STAGE_CATEGORIES,
  STAGE_TEMPLATES,
} from "@/lib/components/collections/aggregations/stage-templates";
...
export const PipelineBuilder: React.FC<Props> = ({ pipeline, onOpenWizard }) => {
