    ...
    <div>
      ...
      <div className="space-y-2">
        <label className="flex items-center justify-between py-1.5 cursor-pointer">
          ...
          <Toggle checked={telemetry} onChange={setTelemetry} label="Enable Usage Statistics" />
        </label>
        <label className="flex items-center justify-between py-1.5 cursor-pointer">
          <span className="text-xs text-foreground">Enable Crash Reports</span>
          <Toggle checked={crashReports} onChange={setCrashReports} label="Enable Crash Reports" />
        </label>
      </div>
