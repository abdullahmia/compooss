...
import { CreateIndexModal } from "./indexes/create-index-modal";
import {
  useGetIndexes,
  useDropIndex,
  useHideIndex,
...
type IndexesTabProps = { readOnly?: boolean };

function getIndexType(key: Record<string, number | string>): string {
...
export const IndexesTab = ({ readOnly = false }: IndexesTabProps) => {
