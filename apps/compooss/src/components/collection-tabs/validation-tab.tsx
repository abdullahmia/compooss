...
type ValidationTabProps = { readOnly?: boolean };

const VALIDATION_LEVELS: { value: ValidationLevel; label: string; description: string }[] = [
...
const VALIDATION_ACTIONS: { value: ValidationAction; label: string; description: string }[] = [
...
const SAMPLE_SIZES = [100, 500, 1000, 5000] as const;
...
export const ValidationTab = ({ readOnly = false }: ValidationTabProps) => {
